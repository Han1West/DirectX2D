...
LEVEL_SAVE CLevel::g_LevelSave = nullptr;
LEVEL_LOAD CLevel::g_LevelLoad = nullptr;
...
void CLevel::SaveRelativePath(FILE* _File)
{
	SaveWString(m_RelativePath, _File);
}

void CLevel::LoadRelativePath(FILE* _File)
{
