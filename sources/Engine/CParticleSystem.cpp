	...
	, m_MaxParticleCount(1000)
{
	...
	SetMaterial(CAssetMgr::GetInst()->FindAsset<CMaterial>(L"Material\\ParticleMtrl.mtrl"));

	// ParticleTick ComputeShader
	m_TickCS = (CParticleTickCS*)CAssetMgr::GetInst()->FindAsset<CComputeShader>(L"ParticleTickCS").Get();

	// Particle Texture
	m_ParticleTex = CAssetMgr::GetInst()->FindAsset<CTexture>(L"Texture\\particle\\HardRain.png");
