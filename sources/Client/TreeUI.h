...
private:
    ...
    EditorUI*           m_DeleteInst;
    EUI_DELEGATE_1      m_DeleteFunc;
...
public:
    ...
    void NodeObjectDelete(TreeNode* _Node);
    ...
    void AddDynamicDelete(EditorUI* _Inst, EUI_DELEGATE_1 _MemFunc) { m_DeleteInst = _Inst; m_DeleteFunc = _MemFunc; }
